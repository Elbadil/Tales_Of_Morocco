"""
Django settings for Tales_Of_Morocco project.
...
SECRET_KEY = 'django-insecure-^)_d7@4lk8ye=pd6vtt#zsb(b_vpi$k&(s*050#bfzgws8-z%f'
...
WSGI_APPLICATION = 'Tales_Of_Morocco.wsgi.application'
